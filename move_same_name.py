...
from_dir='/home/philos/Desktop/dataset/robot_catch_dateset/all_color/'
...
def main():
    ...
    for file in list:
        if (file[-4:]=='.jpg' #and os.path.exists(from_dir+file.replace('.png','.jpg'))):  
# =============================================================================
#             img = cv2.imread(base_dir+file)
#             cv2.imwrite(out_dir+file.replace('.png','.jpg'),img)
# =============================================================================
        
#            shutil.copy(base_dir+file,out_dir+file) 
            shutil.copy(str(from_dir+file),str(out_dir+file))
