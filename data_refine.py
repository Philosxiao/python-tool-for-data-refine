...
def decide_class(label):
    if label=="t":
        ...
        return 3
    elif label=="wrongcolor":
        return 4

all_pics=glob.glob('/home/philos/Desktop/dataset/robot_catch_dateset/all_color/*.jpg')
output_dir="/home/philos/Desktop/dataset/robot_catch_dateset/data_enhance/"
count=0
class_num=0
for pic_path in all_pics:
    ...
    with open(json_path,'r',encoding='utf-8') as json_data:
        ...
        for i in range(len(polygons)):
            x,y,w,h=convert(image.shape[0],image.shape[1],x1=polygons[i][0][0], 
            y1=polygons[i][0][1],
            x2=polygons[i][1][0],
            y2=polygons[i][1][1])
        ...
        for i in range(len(polygons)):
            iabox.append(ia.BoundingBox(x1=polygons[i][0][0], 
            y1=polygons[i][0][1],
            x2=polygons[i][1][0],
            y2=polygons[i][1][1]))
